...
<?php endif;?>
  ...
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Posts (Stories) </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
   ...
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> help@Nellybird.com</p>
                    </div>
